C ##############################################################################
C #     PROGRAM bufrsurface_if3.f based on bufrsurfacefd.f                     #
C #                                                                            #
...
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        INTEGER         INHALE
C        DATA DEFIN(01:10)   /'../bufrobs'/  ! DEFAULT INPUT DIRECTORY
C
...
C
       ...
       write (*,7777)  (infiles(iii),iii=1,10)
7777    format (10(/,1x,a80))
C 7777    format (10(/,1x,a64))
C
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
        ...
        IF (PARSEOK.EQ.'y')  THEN
          NAMTAGL(01:06) = INFILES(KNK)(58:58)
          DASTAGL(01:04) = INFILES(KNK)(48:51)
          CALL LOW2UP (NAMTAGL,NAMETAG,6)
          CALL LOW2UP (DASTAGL,DASTAG,4)
          DATETAG(01:08) = INFILES(KNK)(65:72)
          DATETAG(09:10) = INFILES(KNK)(61:62)
